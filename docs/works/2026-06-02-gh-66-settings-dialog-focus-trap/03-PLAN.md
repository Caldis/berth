...
- [ ] 任务 4: 跑局部、提交前门禁和真实 UI 验收。
  - tests: `pnpm vitest run tests/renderer/settings-dialog.test.tsx`; `pnpm typecheck:web`; `pnpm harness:check --work docs/works/2026-06-02-gh-66-settings-dialog-focus-trap`; `pnpm harness:prepush`
  - verify: agent-owned Electron Settings dialog 中, Tab/Shift+Tab 不会移动到背景页面。
