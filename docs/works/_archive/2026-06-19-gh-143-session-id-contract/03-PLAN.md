...
- [x] 任务 1: `sessionPathHash` + `sessionAssetId` (shared/asset-dedupe.ts)
...
- [x] 任务 2: claude/codex parsers 改用 sessionAssetId (id 不变)
  ...
  - verify: 不适用 UI。回归绿。
- [x] 任务 3: codex 坏行记账 (readJsonLines onMalformed + malformedLineCount)
...
- [x] 任务 4: agent-teams 改用 sessionAssetId
