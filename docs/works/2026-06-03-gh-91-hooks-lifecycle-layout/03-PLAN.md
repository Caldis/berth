...
- [ ] 任务 1:
  ...
  - tests: `pnpm vitest run tests/renderer/hooks-lifecycle-view.test.tsx` 预期新增断言先失败。
  - verify: 覆盖布局层级、交互反馈、可访问性与视觉关联验收项。
- [ ] 任务 2:
...
- [ ] 任务 3:
  ...
  - tests: `pnpm vitest run tests/renderer/hooks-lifecycle-view.test.tsx`; `pnpm typecheck:web`
