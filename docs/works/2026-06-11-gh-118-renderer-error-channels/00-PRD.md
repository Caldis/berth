...
来源: `docs/issues/2026-06-10-IMPROVEMENT-renderer-swallowed-error-channels.md` (快照于 2026-06-11) + GitHub Issue #118
...
- 行号已漂移 (GH-116 重构 use-ipc.ts 后): 当前 5 处为 `use-ipc.ts` 138/156/396/437 + `use-memory.ts` 65 (grep 核实)。
- issue 所引样板提交与测试文件均在仓 (tests/renderer/session-error.test.tsx 存在)。
