...
- `pnpm harness:prepush` - local lint/typecheck/test/harness checks passed, but command failed on `harness:ci:baseline` because latest remote CI run `8cfbda3` completed with failure.
