...
4. ~~app_icon.png/app_icon_v2.png (3.56MB) 接线或删除决策~~ — **DONE (2026-06-10, 删除)**: 全仓零引用核验 (src/electron-builder.yml/package.json/vite config/tests/scripts/website 均无), 按本条预案「不接则删」执行 `git rm`, git 历史可恢复; 未来接线 app icon 属产品视觉新需求另立案。
