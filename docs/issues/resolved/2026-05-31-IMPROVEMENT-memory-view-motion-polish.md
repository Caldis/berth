...
- MemoryView 在 setFocusId 后起一个约 2s timer 清空 focusId; reduced-motion 时禁用脉冲动画。

# 完成记录
- Work: `docs/works/_archive/2026-06-02-gh-21-memory-view-motion-polish`
- Code: `src/renderer/src/components/memory/memory-view.tsx`
- Tests: `tests/renderer/memory-view.test.tsx`
