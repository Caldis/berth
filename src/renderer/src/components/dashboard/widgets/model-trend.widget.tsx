...
export function ModelTrendWidget({ size }: WidgetRenderProps): React.ReactElement {
  ...
  const chartHeight = size === 'Wide' ? 188 : size === 'L' ? 156 : 124
  const showHeader = size === 'L' || size === 'Wide'
