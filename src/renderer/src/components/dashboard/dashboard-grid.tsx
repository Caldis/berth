...
import { ROW_UNIT, widthColSpanClass, heightRowSpan } from '@/lib/widget-grid'
  ...
  return (
    ...
    >
      <SortableContext items={ids} strategy={rectSortingStrategy}>
        <div
          className="grid grid-cols-1 items-start gap-6 md:grid-cols-2 md:grid-flow-row-dense xl:grid-cols-4"
...
function SortableWidget({
  ...
  const style: CSSProperties = {
    ...
    transition,
    gridRow: `span ${heightRowSpan(item.size.h)}`
  }
